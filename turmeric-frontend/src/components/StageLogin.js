        ...
        <div className="grid grid-cols-2 gap-4">
          {STAGES.map((stage) => (
            <button
              ...
              className={`bg-gradient-to-br from-${stage.color}-50 to-${stage.color}-100 p-5 rounded-xl border-2 border-transparent hover:border-${stage.color}-300 transition-all duration-200 group text-center`}
            >
              <div className={`bg-${stage.color}-100 p-3 rounded-lg w-14 h-14 mx-auto mb-3 flex items-center justify-center group-hover:scale-110 transition-transform duration-200`}>
                <User className={`text-${stage.color}-600`} size={28} />
              </div>
              <h3 className={`text-lg font-bold text-${stage.color}-800 mb-1`}>
                {stage.name}
              </h3>
              <p className={`text-${stage.color}-600 text-xs`}>
                {stage.description}
              </p>
            </button>
          ))}
